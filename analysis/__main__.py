...
def main():
    ...
    parser.add_argument("--preprint-figures", default=None, metavar="DIR",
                         help="Also write the two preprint figures (preprint_fig5.png, "
                              "preprint_fig6.png) into DIR — pass thesis/figures to "
    ...
    if args.preprint_figures:
        ...
        if likert is None:
            print("NOTE: no Likert data — skipping preprint_fig6.png.")
        else:
